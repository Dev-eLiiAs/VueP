    ...
    <header class="bg-white">
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <PopoverGroup class="hidden lg:flex lg:gap-x-12">
                ...
                <router-link to="/tabla" class="text-sm font-semibold leading-6 text-gray-900">Tabla</router-link>
                <router-link to="/form" class="text-sm font-semibold leading-6 text-gray-900">Formulario</router-link>
